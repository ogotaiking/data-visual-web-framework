...
module.exports = function(passport) {
    ...
    function(req, userid, password, done) {
        ...
        process.nextTick(function() {
            User.findOne({$or:[{ 'local.email' :  userid },{ 'local.username' :  userid }]}, function(err, user) {
                ...
                if (!user)
                    return done(null, false, req.flash('loginMessage', 'UserNotFound'));
    ...
    function(req, email, password,  done) {
        ...
        //validate username does not contain invalid char like @
